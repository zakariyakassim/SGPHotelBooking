...
public class DatePicker extends JComboBox {
	...
	protected Color selectedBackground = new Color(22, 160, 133);
	protected Color selectedForeground = new Color(240,240,240);
	protected Color background = new Color(240, 240, 240);
	protected Color foreground = new Color(22, 160, 133);
	...
	protected void initializePopup() {
	    ...
	    popup.setBorder(BorderFactory.createLineBorder(new Color(22, 160, 133)));
